...
def main():
    ...
    parser.add_argument(
        "--project-key",
        default="{{ cookiecutter.github_org_or_user }}_{{ cookiecutter.project_slug }}",
        help="SonarQube project key (default: {{ cookiecutter.github_org_or_user }}_{{ cookiecutter.project_slug }})"
    )
    parser.add_argument(
        "--token",
    ...
    parser.add_argument(
        "--org",
        default=os.environ.get("SONAR_ORG", "{{ cookiecutter.github_org_or_user }}"),
        help="SonarQube organization (default: {{ cookiecutter.github_org_or_user }})"
    )
    parser.add_argument(
        "--rad-tags",
        type=int,
